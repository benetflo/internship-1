...
#define BURN_MAX_SIZE 512 * 1024

extern int low_memory_mode;
extern uint8_t g_nv_src_buffer[BURN_MAX_SIZE];
extern uint8_t g_nv_dst_buffer[BURN_MAX_SIZE];
extern char g_backup_file_path[256];
extern char g_nv_fix_path[256];
extern FILE *out_fp;
